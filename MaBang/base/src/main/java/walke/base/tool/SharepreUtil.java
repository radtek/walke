...
public class SharepreUtil {
    ...
    public static void putInt(Context context, String key, Integer tagInt) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(key,tagInt);
        editor.commit();
    }

    public static int getInt(Context context, String key,Integer defaultInt) {
