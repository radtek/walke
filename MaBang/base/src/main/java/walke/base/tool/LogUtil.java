...
/**
 * Custom LogUtil class, a wrap of {@link android.util.Log}
 *
 * @author wlf(Andy) update by View
...
public final class LogUtil {
    ...
    public static void setDebugMode(boolean isDebugMode) {
        LogUtil.sIsDebugMode = isDebugMode;
    }
     ...
     * Send a {@link android.util.Log#VERBOSE} log message.
     *
     * @param obj Used to identify the source of a log message.  It usually identifies
     *            the class or activity where the log call occurs.
     * @param msg The message you would like logged.
     */
    ...
    public static int e(String tag, String msg) {
        if (sIsDebugMode) {
            if (TextUtils.isEmpty(tag)) tag="View";
    ...
    public static int e(Object obj, String msg) {
        if (sIsDebugMode) {
            if (TextUtils.isEmpty(obj.getClass().getSimpleName())) obj="walke";
