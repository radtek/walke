...
public class Util {
    ...
    */
    ...
    public static boolean IsMobile(String mobile) {
        return mobile != null && mobile.length() == 11 && Pattern.matches("^1(3|4|5|7|8)\\d{9}$", mobile);
    }
    ...
    public static boolean IsPhone(final String phone) {
        ...
        if (phone.length() > 8) {
            if (phone.indexOf("-") > -1)
                return Pattern.matches("^[0][0-9]{2,3}-[0-9]{5,10}$", phone);
            else
                return Pattern.matches("^[0][0-9]{9,10}$", phone);
        }
        return Pattern.matches("^[1-9]{1}[0-9]{5,8}$", phone);
    }
