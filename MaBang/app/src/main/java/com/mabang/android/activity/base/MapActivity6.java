...
// */
//
//public abstract class MapActivity6 extends AppActivity {
//
...
//                if (b || b2) {
//                    DialogUtil.tipsOneButton(MapActivity6.this, "好的", "获取定位失败，请检查并确认\n系统设置的“位置信息”选项开启后重试", new DialogUtil.OneButtonClickListener() {
//                        @Override
...
//                }
//
//                if (!NetWorkUtil.isNetworkConnected(MapActivity6.this)) {
//                    toast("网络连接不可用");//
//
...
//                        if (MapActivity6.this instanceof WorkerHomeActivity)
...
//
//                if (MapActivity6.this instanceof UserHomeActivity) {
...
//    }
//
//    public void initWorkerOverlay(final SearchInfo searchInfo) {
...
//    }
//
//    public void initWorkerOverlay(final SearchInfo searchInfo, BillboardInfo billboardInfo) {
//        List<BillboardInfo> billboardInfoList = searchInfo.getBillboardInfoList();
//        if (billboardInfoList != null) {
//            mBaiduMap.clear();
//        } else {
...
//    }
//
//    public void initOverlay(final SearchInfo searchInfo) {
//        List<BillboardInfo> billboardInfoList = searchInfo.getBillboardInfoList();
//        if (billboardInfoList != null) {
////            overlayViewList.clear();
//            mBaiduMap.clear();
...
//    }
//
//    public void initOverlay(final SearchInfo searchInfo, BillboardInfo billboardInfo) {
//        List<BillboardInfo> billboardInfoList = searchInfo.getBillboardInfoList();
//        if (billboardInfoList != null) {
//            mBaiduMap.clear();
//        } else {
...
//        LatLng latLng = null;
//        if (str != null) {
//            Geocoder gc = new Geocoder(MapActivity6.this, Locale.CHINA);
