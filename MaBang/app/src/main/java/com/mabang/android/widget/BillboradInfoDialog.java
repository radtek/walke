 ...
 * 故需要设置为全局变量
 */
public class BillboradInfoDialog extends MyDialog {
    ...
    public BillboradInfoDialog(@NonNull Context context) {
        this(context, R.style.dialog_default);
    }

    public BillboradInfoDialog(@NonNull Context context, @StyleRes int themeResId) {
    ...
    private void init(final Context context) {
        ...
        mIvCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (BillboradInfoDialog.this.isShowing()) {
                    BillboradInfoDialog.this.dismiss();
                }
            }
        });
