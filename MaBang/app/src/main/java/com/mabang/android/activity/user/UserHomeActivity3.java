...
// */
//
//public class UserHomeActivity3 extends MapActivity implements HomeUserTopView.HomeTopViewClickListener, RadioGroup.OnCheckedChangeListener, DropDownAlertDialog.OnDropDownAlertDialogEvent, DropDownAlertDialog.OnAlertDialogEvent {
...
//            @Override
//            public void done() {
//                DialogManager.dialogBillboardInfoOneButton(UserHomeActivity3.this, markerInfo, "详情", new DialogManager.OneButtonClickListener() {
//                    @Override
...
//                }
//            });
//            if (!NetWorkUtil.isNetworkConnected(UserHomeActivity3.this)) {
//                toast("网络连接不可用");
//            } else {
//                //
...
//
//                    UserHomeActivity3.this.changeAddressDialog.provincePanel.append(provinceList, result.getProvinceId());
//                    if (panelIndex == -1) {
//                        UserHomeActivity3.this.changeAddressDialog.provincePanel.scrollActive();
//                    }
//
//                    UserHomeActivity3.this.changeAddressDialog.cityPanel.append(cityList, result.getCityId());
//                    if (panelIndex <= 1) {
//                        UserHomeActivity3.this.changeAddressDialog.cityPanel.scrollActive();
//                    }
//
//                    UserHomeActivity3.this.changeAddressDialog.zonePanel.append(zoneList, result.getZoneId());
//                    if (panelIndex <= 2) {
//                        UserHomeActivity3.this.changeAddressDialog.zonePanel.scrollActive();
//                    }
//
//                    if (streetList != null && streetList.size() > 0) {
//                        UserHomeActivity3.this.changeAddressDialog.streetPanel.setVisibility(View.VISIBLE);
//                        UserHomeActivity3.this.changeAddressDialog.streetPanel.append(streetList, result.getStreetId());
//                        UserHomeActivity3.this.changeAddressDialog.streetPanel.scrollActive();
//                    } else
//                        UserHomeActivity3.this.changeAddressDialog.streetPanel.setVisibility(View.GONE);
//                    UserHomeActivity3.this.changeAddressDialog.changeSize();
//                }
//                return;
//            }
//
...
//            @Override
//            public void onFinish() {
//                UserHomeActivity3.this.changeAddressDialog.hideLoad();
//                return;
//            }
//        });
//
