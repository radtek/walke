...
// */
//
//public class UserHomeActivity2 extends MapActivity implements HomeUserTopView.HomeTopViewClickListener, RadioGroup.OnCheckedChangeListener, DropDownAlertDialog.OnDropDownAlertDialogEvent, DropDownAlertDialog.OnAlertDialogEvent {
...
//            @Override
//            public void done() {
//                DialogManager.dialogBillboardInfoOneButton(UserHomeActivity2.this, markerInfo, "详情", new DialogManager.OneButtonClickListener() {
//                    @Override
...
//                }
//            });
//            if (!NetWorkUtil.isNetworkConnected(UserHomeActivity2.this)) {
//                toast("网络连接不可用");
//            }else {
//                //
...
//
//                    UserHomeActivity2.this.changeAddressDialog.provincePanel.append(provinceList, result.getProvinceId());
//                    if (panelIndex == -1) {
//                        UserHomeActivity2.this.changeAddressDialog.provincePanel.scrollActive();
//                    }
//
//                    UserHomeActivity2.this.changeAddressDialog.cityPanel.append(cityList, result.getCityId());
//                    if (panelIndex <= 1) {
//                        UserHomeActivity2.this.changeAddressDialog.cityPanel.scrollActive();
//                    }
//
//                    UserHomeActivity2.this.changeAddressDialog.zonePanel.append(zoneList, result.getZoneId());
//                    if (panelIndex <= 2) {
//                        UserHomeActivity2.this.changeAddressDialog.zonePanel.scrollActive();
//                    }
//
//                    if (streetList != null && streetList.size() > 0) {
//                        UserHomeActivity2.this.changeAddressDialog.streetPanel.setVisibility(View.VISIBLE);
//                        UserHomeActivity2.this.changeAddressDialog.streetPanel.append(streetList, result.getStreetId());
//                        UserHomeActivity2.this.changeAddressDialog.streetPanel.scrollActive();
//                    } else
//                        UserHomeActivity2.this.changeAddressDialog.streetPanel.setVisibility(View.GONE);
//                    UserHomeActivity2.this.changeAddressDialog.changeSize();
//                }
//                return;
//            }
//
...
//            @Override
//            public void onFinish() {
//                UserHomeActivity2.this.changeAddressDialog.hideLoad();
//                return;
//            }
//        });
//
