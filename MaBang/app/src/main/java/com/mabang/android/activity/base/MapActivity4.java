...
// */
//
//public abstract class MapActivity4 extends AppActivity {
//
...
//                            ShopCarUtil.setAnim(MapActivity4.this, overlayViewList.get(i), point, 500, new ShopCarUtil.AnimListener() {
//                                @Override
//                                public void end() {
//                                    mapMarkerClick(marker);
//                                    if (mMarkerBind != null && mMarkerBind == marker)
...
//                        if (MapActivity4.this instanceof WorkerHomeActivity)
...
//                mEndPoint[1] = lly.longitude;
//
//                if (MapActivity4.this instanceof UserHomeActivity) {
...
//        LatLng latLng = null;
//        if (str != null) {
//            Geocoder gc = new Geocoder(MapActivity4.this, Locale.CHINA);
