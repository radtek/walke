...
public class MyDateUtils {
    ...
    public static Date dateAdd(Date date, int days, boolean includeTime) throws ParseException{
        ...
        if(!includeTime){
            SimpleDateFormat sdf = new SimpleDateFormat(MyDateUtils.DATE_PATTERN);
    ...
    public static String dateFormat(Date date, String pattern) throws ParseException{
        if(TextUtils.isEmpty(pattern)){
            pattern = MyDateUtils.DATE_PATTERN;
        }
    ...
    public static String dateTimeToDateString(Date dateTime) throws ParseException{
        String dateTimeString = MyDateUtils.dateFormat(dateTime, MyDateUtils.DATE_TIME_PATTERN);
