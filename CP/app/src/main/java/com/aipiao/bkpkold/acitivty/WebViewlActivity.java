...
public class WebViewlActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        webTopView.getTopTitleTextView().setText("竞彩学院");
        trendwebview = (BridgeWebView) findViewById(R.id.webview);
        trendwebview.loadUrl("https://statics.xiaobaicp.com/page/found/jcxy/index.html?from=singlemessage&VERSION=6.2.0&PACKAGE=com.iletou.caipiao&fromshare=android");
